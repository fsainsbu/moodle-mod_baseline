...
require_once("$CFG->dirroot/mod/baseline/locallib.php");
 ...
 * is due to change.
 */
Mock::generate('baseline_portfolio_caller', 'mock_caller');
Mock::generate('portfolio_exporter', 'mock_exporter');

class testBaselinePortfolioCallers extends portfoliolib_test {
/*
    public static $includecoverage = array('lib/portfoliolib.php', 'mod/baseline/lib.php');
    public $module_type = 'baseline';
    ...
    public function setUp() {
        ...
        generator_generate_baseline($settings);
        ...
        $fields = $DB->get_records('baseline_fields', array('baselineid' => $first_module->id));
        $recordid = baseline_add_record($first_module);
        ...
        $this->caller_single = parent::setup_caller('baseline_portfolio_caller', array('id' => $cm->id, 'record' => $recordid));
        $this->caller = parent::setup_caller('baseline_portfolio_caller', array('id' => $cm->id));
    }
