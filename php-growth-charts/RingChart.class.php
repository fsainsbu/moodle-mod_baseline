...
class RingChart
{
	 ...
	 * @return RingChart
	 */
	public function RingChart($style, $sex, $maxAgeMonths, $width = 800, $height = 800, $patientXarray = null, $patientYarray = null)
	{
		$this->style = $style;
		$this->title = $title;
...
$p1->midtitle->SetFont(FF_ARIAL,FS_NORMAL,8);
