...
25005 => array('Can\'t access PHP_SELF, PHP global $DB,variable. You can\'t run PHP from command line if you want to use the \'auto\' naming of cache or image files.',0),
