...
/**
 * Strings for component 'baseline', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   baseline
...
$string['example'] = 'Baselinebase module example';
$string['excel'] = 'Excel';
...
$string['filtername'] = 'Baselinebase auto-linking';
...
$string['modulename'] = 'Baselinebase';
...
$string['modulenameplural'] = 'Baselinebases';
$string['more'] = 'More';
...
$string['pluginadministration'] = 'Baselinebase activity administration';
$string['pluginname'] = 'Baselinebase';
...
Note: If entries are required before viewing, the baseline auto-linking filter should be disabled. This is because the baseline auto-linking filter can\'t determine whether a user has submitted the required number of entries.';
...
$string['subplugintype_baselinefield'] = 'Baselinebase field type';
$string['subplugintype_baselinefield_plural'] = 'Baselinebase field types';
...
$string['undefinedprocessactionmethod'] = 'No action method defined in Baseline_Preset to handle action "{$a}".';
...
* Each record is a series of baseline separated by commas (or other delimiters)
