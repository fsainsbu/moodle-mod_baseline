...
class baseline_field_menu extends baseline_field_base {
    ...
    function display_add_field($recordid=0) {
        ...
        $str .= html_writer::select($options, 'field_'.$this->field->id, $content, array(''=>get_string('menuchoose', 'baseline')), array('id'=>'field_'.$this->field->id));
