...
class baseline_field_file extends baseline_field_base {
    var $type = 'file';
    ...
    function display_add_field($recordid=0) {
        ...
        // editing an existing baseline entry
        if ($recordid){
        ...
        $module = array('name'=>'baseline_filepicker', 'fullpath'=>'/mod/baseline/baseline.js', 'requires'=>array('core_filepicker'));
        $PAGE->requires->js_init_call('M.baseline_filepicker.init', array($fp->options), true, $module);
