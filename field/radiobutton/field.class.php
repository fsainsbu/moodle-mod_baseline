...
class baseline_field_radiobutton extends baseline_field_base {
    ...
    function display_add_field($recordid=0) {
        ...
        if ($recordid){
            $content = trim($DB->get_field('baseline_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid)));
        } else {
            $content = '';
        }
